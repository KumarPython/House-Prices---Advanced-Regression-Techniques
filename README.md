...
4. Dropping some useless column. Also dropping some columns with more NULL values
...
6. Imputing the missing values
7. Transforming Dates
8. Apply Log Transform on Continuous Data only
9. Standardizing the Discrete Values.
10. Handling Categorical Data using Get_Dummies()
11. Concatenating the Original Dataset & the One after creating Dummies(get_dummies()
12. Dropping the columns already concatenated after Get_Dummies()
